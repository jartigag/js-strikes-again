...
___ Use the filter Method to Extract Data from an Array ___
...
var filteredList = watchList.map(({ Title: title, imdbRating: rating }) => ({title, rating})).filter(movie => movie.rating > 8.0);
